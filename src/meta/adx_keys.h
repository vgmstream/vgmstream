...
static const adxkey_info adxkey9_list[] = {
        ...
        /* AKA to BLUE (Android) */
        {0x03fc,0x0749,0x12EF, NULL,0},                     // guessed with VGAudio/CriCodecs (possible key: 1FE0748978 / 136909719928)
      //{0x0c03,0x0749,0x1459, NULL,0},                     // 2nd guess (possible key: 6018748A2D / 412727151149)
        ...
        // CHUNITHM NEW (AC)
        {0x0000,0x0000,0x0000, NULL,32931609366120192},     // 0074FF1FCE264700
