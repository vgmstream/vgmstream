...
static bool ubi_bao_config_version(ubi_bao_config_t* cfg, STREAMFILE* sf, uint32_t version);
static void ubi_bao_config_endian(ubi_bao_config_t* cfg, STREAMFILE* sf, off_t offset);
...
static void config_bao_audio_c(ubi_bao_config_t* cfg, off_t cue_count, off_t cue_size) {
    /* audio header extra */
    cfg->audio_cue_count            = cue_count;
...
static bool ubi_bao_config_version(ubi_bao_config_t* cfg, STREAMFILE* sf, uint32_t version) {
    ...
    cfg->allowed_types[0x01] = true;
    cfg->allowed_types[0x05] = true;
    cfg->allowed_types[0x06] = true;
    ...
    if (cfg->version & 0xFFFF0000 >= 0x002B0000) {
         ...
         * 0x14: class
         * 0x18: config/version? (0x02)
         * 0x1c: fixed value per type? (0x17CE46D9 = header)
         * (header skip)
         * 0x20: header_id
         * 0x34: header_type?
         */
    ...
    /* config per version (all offset from header_skip defined below) */
    switch(cfg->version) {
      ...
      //case 0x001B0100: // Your Shape featuring Jenny McCarthy (Wii)-atomic-forge
            ...
            cfg->audio_interleave = 0x10;
            cfg->audio_fix_psx_samples = true;
        ...
        case 0x0022001B: // Prince of Persia: The Forgotten Sands (Wii)-package
            ...
            config_bao_audio_m(cfg, 0x44, 0x4c, 0x54, 0x5c, 0x64, 0x74); // cues: 0x68, 0x6c
      ...
      //case 0x002B0000: // Far Cry 4 (multi)-spk-dunia
        case 0x002B0100: // Far Cry 4 (multi)-spk-dunia
            ...
            */
            ...
            cfg->codec_map[0x08] = FMT_MP3; // PS3
