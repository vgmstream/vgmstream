...
function Init
{
    ...
    Start-Process cmake -NoNewWindow -ArgumentList "-G `"Visual Studio 15 2017`" -T v141_xp -DJANSSON_BUILD_SHARED_LIBS=1 -DJANSSON_BUILD_DOCS=OFF .." -ErrorAction Ignore -WarningAction Ignore -Wait
    Set-Location "..\..\..\"
}
