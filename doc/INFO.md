...
- [Hundreds of video game music formats and codecs](FORMATS.md), from typical game engine files
...
- [TXTH](TXTH.md) function, to add external support for extra formats, including raw audio in
  many forms.
- [TXTP](TXTP.md) function, for real-time and per-file config, like forced looping, removing
...
See [components](USAGE.md#components) in the *usage guide* for full install instructions and
...
[build guide](BUILD.md) for more information.
...
[build guide](BUILD.md) describes this process in more detail. For a quick build on Debian and
...
### macOS
Please follow the [build guide](BUILD.md).


## More info
- [Usage guide](USAGE.md)
- [List of supported audio formats](FORMATS.md)
- [Build guide](BUILD.md)
- [TXTH file format](TXTH.md)
- [TXTP file format](TXTP.md)
